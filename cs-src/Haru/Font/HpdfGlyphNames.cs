/*
 * << Haru Free PDF Library >> -- HpdfGlyphNames.cs
 *
...
namespace Haru.Font
{
    ...
    /// Based on libharu's HPDF_UNICODE_GRYPH_NAME_MAP table from hpdf_encoder.c.
    /// This table contains 1051 mappings for standard PostScript glyph names.
    /// </summary>
    internal static class HpdfGlyphNames
    {
        private static readonly Dictionary<ushort, string> _glyphNameMap = new Dictionary<ushort, string>
        {
            { 0x0020, "space" },
            { 0x0021, "exclam" },
            { 0x0022, "quotedbl" },
            ...
            { 0xF7A2, "Hungarumlautsmall" },
            { 0xF7A8, "Dollaroldstyle" },
            { 0xF7AF, "dollaroldstyle" },
            { 0xF7B4, "zerooldstyle" },
            { 0xF7B5, "oneoldstyle" },
            { 0xF7B6, "twooldstyle" },
            { 0xF7B7, "threeoldstyle" },
            { 0xF7B8, "fouroldstyle" },
            { 0xF7B9, "fiveoldstyle" },
            { 0xF7BA, "sixoldstyle" },
            { 0xF7BB, "sevenoldstyle" },
            { 0xF7BC, "eightoldstyle" },
            { 0xF7BD, "nineoldstyle" },
        ...
        /// </summary>
        /// <param name="unicode">The Unicode codepoint.</param>
        /// <returns>The PostScript glyph name, or null if not found.</returns>
        ...
        /// <summary>
        /// Checks if a glyph name exists for the given Unicode codepoint.
        /// </summary>
        /// <param name="unicode">The Unicode codepoint.</param>
        /// <returns>True if a mapping exists, false otherwise.</returns>
        public static bool HasGlyphName(ushort unicode)
        {
            return _glyphNameMap.ContainsKey(unicode);
        }
    }
}
